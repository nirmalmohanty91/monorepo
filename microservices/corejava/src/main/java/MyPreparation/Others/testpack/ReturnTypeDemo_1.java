...
public class ReturnTypeDemo_1 {
	...
	public static void main(String[] args) {
		ReturnTypeDemo_1 returnType=new ReturnTypeDemo_1();//-->Instance of a class which loads all the non-static members
		...
		System.out.println(returnType.function1(4)+4);  //We can even pass expressions,not alone arguments
